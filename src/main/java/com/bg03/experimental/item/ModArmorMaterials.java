...
public class ModArmorMaterials {
    public static final RegistryEntry<ArmorMaterial> FLUORITE_ARMOR_MATERIAL = registerArmorMaterial("fluorite",
            () -> new ArmorMaterial(
                    ...
                    List.of(new ArmorMaterial.Layer(Identifier.of(Experimental.MOD_ID, "fluorite"))), 0, 0));

    public static RegistryEntry<ArmorMaterial> registerArmorMaterial(String name, Supplier<ArmorMaterial> material) {
        return Registry.registerReference(Registries.ARMOR_MATERIAL, Identifier.of(Experimental.MOD_ID, name), material.get());
    }
}
