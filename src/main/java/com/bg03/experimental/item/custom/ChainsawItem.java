...
public class ChainsawItem extends Item {
    ...
    public void appendTooltip(ItemStack stack, TooltipContext context, List<Text> tooltip, TooltipType type) {
        if (!Screen.hasShiftDown()) {
            tooltip.add(Text.translatable("tooltip.experimental.chainsaw.tooltip.shift"));
        } else {
            tooltip.add(Text.translatable("tooltip.experimental.chainsaw.tooltip.1"));
            tooltip.add(Text.translatable("tooltip.experimental.chainsaw.tooltip.2"));
        }
