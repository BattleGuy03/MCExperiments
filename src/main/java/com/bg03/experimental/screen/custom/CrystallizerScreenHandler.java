...
public class CrystallizerScreenHandler extends ScreenHandler {
    ...
    public CrystallizerScreenHandler(int synId, PlayerInventory playerInventory, BlockEntity blockEntity, PropertyDelegate arrayPropertyDelegate) {
        super(ModScreenHandlers.CRYSTALLIZER_SCREEN_HANDLER, synId);
    ...
    public int getScaledCrystalProgress() {
        ...
        return progress != 0 && maxProgress != 0 ? progress * crystalPixelSize / maxProgress : 0;
    }
